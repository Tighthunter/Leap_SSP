...
public class Gesture
{
    ...
    public static readonly Gesture GestureScissors = new Gesture("Scissors", 3, new int[] { 2 }, new PointingState[] { PointingState.NotExtended, PointingState.Extended, PointingState.Extended, PointingState.NotExtended, PointingState.NotExtended });
}
